#if MICROSOFT_EXTENSIONS_AI_ENABLED
...
namespace Microsoft.ML.OnnxRuntimeGenAI
{
    ...
    public sealed class OnnxRuntimeGenAIChatClient : IChatClient
    {
        ...
        private sealed class CachedGenerator : IDisposable
        {
            public CachedGenerator(Generator generator)
            {
                Generator = generator;
            }
...
#endif // MICROSOFT_EXTENSIONS_AI_ENABLED
